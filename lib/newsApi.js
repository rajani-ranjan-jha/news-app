...
export async function getTopHeadlines(category) {
    try {
        const url = `${BASE_URL}/top-headlines?country=us&category=${category}&pageSize=24&apiKey=${API_KEY}`;
...
export async function getAllTopHeadlines() {
    try {
        ...
        const url = `${BASE_URL}/top-headlines?country=us&pageSize=25&apiKey=${API_KEY}`;
