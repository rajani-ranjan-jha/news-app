      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="w-full flex lg:flex-row flex-col justify-between items-center gap-5">
          ...
          <div className="space-y-3">
            ...
            <ul className="flex justfy-center items-center gap-3 flex-wrap">
              {categories.map((cat, i) => (
                <li>
                  <Link className="text-sm underline" key={i} href={cat.path}>
                    {cat.name}
                  </Link>
                </li>
              ))}
          ...
          <div className="space-y-3">
            ...
            <a className="underline" href="mailto:rajanijha50@gmail.com">
              rajanijha50@gmail.com
            </a>
            <br />
            <a className="underline" href="tel:+91-7004668979">
              +91-7004668979
            </a>
          </div>
        </div>
