        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li><a href="/categories" className="text-sm text-gray-600 hover:text-gray-900">Categories</a></li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li><a href="/politics" className="text-sm text-gray-600 hover:text-gray-900">Politics</a></li>
              <li><a href="/technology" className="text-sm text-gray-600 hover:text-gray-900">Technology</a></li>
              <li><a href="/sports" className="text-sm text-gray-600 hover:text-gray-900">Sports</a></li>
